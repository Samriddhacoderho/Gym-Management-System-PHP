...
<head>
    ...
    <link rel="stylesheet" href="membereditform.css">
...
<body>
    ...
    if(!$connection){
        ...
        $id=$_GET['id'];
        $query="SELECT * FROM main_gym_user WHERE id=$id";
    ...
    <form class='user_entryform' action="memberedit.php" method="post">
        ...
        <label for="contact_number">Membership Type:</label>
        <input type="text" name="membership_type" id="membership_type" value="<?php echo  $membership_type ?>">
